...
async function saveProfile(event) {
  ...
  try {
    ...
    const updatedCustomer = await db.customers.update(user.id, updatedData);
    
    if (updatedCustomer) {
      // Update local user object with all fields from database
      const updatedUser = {
        ...user,
        ...updatedCustomer,
...
// ============================================================================
// Make functions accessible for inline onclick/onsubmit handlers
